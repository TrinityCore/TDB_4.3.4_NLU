DELETE FROM `creature_text` WHERE `entry` IN (52322,52077,52150,52053,52956,52381,52438,52380,52148,52059,52650,52222,52151,52271,52958,52155);
...
-- Gurubashi Berserker
(52077, 0, 0, '%s is chasing you. Run!', 42, 0, 100, 0, 0, 0, 'Gurubashi Berserker - Pursuit emote'),
...
(52053, 5, 0, 'You''ll all suffer for this! Zul''Gurub is NOTHING without Zan... Zan...', 14, 0, 100, 0, 0, 24338, 'Zanzil - Death'),
...
(52059, 4, 0, 'This body is useless!', 14, 0, 100, 0, 0, 24274, 'High Priestess Kilnara - Death'),
-- Shadow of Hakkar
...
(52151, 1, 0, 'Ha ha ha! Is that all you got?', 14, 0, 100, 0, 0, 24293, 'Bloodlord Mandokir - Killing A Player'),
...
(52271, 2, 0, 'My spirit dreams no longer...', 14, 0, 100, 0, 0, 24248, 'Hazza''rah - Death'),
...
(52155, 6, 0, 'My death means...nothing...', 14, 0, 100, 0, 0, 24318, 'High Priest Venoxis - Death');
